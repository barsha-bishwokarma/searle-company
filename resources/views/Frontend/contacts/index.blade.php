<x-frontend.layout>
            ...
            <div class="flex-1 w-full">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-12">
                    ...
                    <div class="flex flex-col items-center text-center">
                        ...
                        <h3 class="font-bold text-gray-700 text-lg sm:text-xl mb-2">Office Address</h3>
                    ...
                    <div class="flex flex-col items-center text-center">
                        ...
                        <h3 class="font-bold text-gray-700 text-lg sm:text-xl mb-2">Phone</h3>
                        <p class="text-gray-500 text-sm leading-6 text-center">
                    ...
                    <div class="flex flex-col items-center text-center">
                        ...
                        <h3 class="font-bold text-gray-700 text-lg sm:text-xl mb-2">Email</h3>
                        <p class="text-gray-500 text-sm leading-6 text-center">
                    ...
                    <div class="flex flex-col items-center text-center">
                        ...
                        <h3 class="font-bold text-gray-700 text-lg sm:text-xl mb-2">
                            For Business Development email at:
                        </h3>
                        <p class="text-gray-500 text-sm leading-6 text-center">
                ...
                {{-- Social Icons --}}
                <div class="flex gap-4 mt-10 pl-2 justify-center sm:justify-start">
                    <a href="#"
    ...
    <div class="relative min-h-screen flex items-center justify-center py-12 sm:py-20"
        ...
        <div class="relative z-10 w-full max-w-3xl mx-auto px-4 sm:px-6">
            ...
            <div class="text-center mb-10">
                <h1
                    class="text-2xl sm:text-3xl md:text-4xl font-bold text-white tracking-[0.2em] sm:tracking-[0.3em] uppercase mb-3">
                    Contact
                </h1>

                <p class="text-[10px] sm:text-xs text-gray-400 tracking-[0.2em] sm:tracking-[0.4em] uppercase">
            ...
            <form action="{{ route('contact.submit') }}" method="POST" class="space-y-4">
                ...
                <div class="flex justify-center pt-2">
                    <button type="submit"
                        class="px-8 sm:px-12 py-3 bg-white/90 text-gray-700 text-sm tracking-widest uppercase hover:bg-white transition-all duration-300">
                        Submit
                    </button>
                </div>
